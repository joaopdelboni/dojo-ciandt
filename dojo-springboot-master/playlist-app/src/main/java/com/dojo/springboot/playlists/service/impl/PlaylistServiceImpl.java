...
import com.dojo.springboot.playlists.entity.PlaylistMusicas;
...
public class PlaylistServiceImpl implements PlaylistService {
	...
	private List<PlaylistMusicasModel> buildPlaylistMusicas(List<PlaylistMusicas> musicas, Playlist playlist) {
		List<PlaylistMusicasModel> playlistMusicas = new ArrayList<PlaylistMusicasModel>();
		if (musicas != null) {
			for (PlaylistMusicas musica : musicas) {
	...
	private PlaylistMusicasModel buildPlaylistMusica(PlaylistMusicas musica, Playlist playlist) {
		PlaylistMusicasModel playlistMusica = new PlaylistMusicasModel();
		playlistMusica.setMusicaId(musica.getMusicaId());
		Musica musicaRico = musicaService.getById(musica.getMusicaId());
		playlistMusica.setMusica(musicaRico);
